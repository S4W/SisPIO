...
db.define_table(
    ...
    Field('telefono_representante_oficina', type ='integer', length=12, requires=IS_MATCH('^((0)?2[0-9]{2}(-)?)?[0-9]{7}$', error_message='Telefono Oficina Invalido.')),
    Field('telefono_representante_otro', type ='integer', length=12, requires=IS_MATCH('^((0)?[0-9]{3}(-)?)?[0-9]{7}$', error_message='Telefono Invalido.')),
